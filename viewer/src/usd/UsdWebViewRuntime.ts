...
// Patched for USD 4D BIM: resolve against Vite's configured base (e.g. "/viewer/"
// when this build is mounted under a subpath) instead of the app root.
const RUNTIME_ENTRYPOINT = `${import.meta.env.BASE_URL}usd-webview-bindings/usdWebViewBindings.js?v=${WASM_BUILD_NAME}`;
const RUNTIME_ASSET_ROOT = `${import.meta.env.BASE_URL}usd-webview-bindings/`;
